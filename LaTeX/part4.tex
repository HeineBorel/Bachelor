...
Departing from this example, let $\hs$ be a Hilbert space and 
$\Phi\colon \cf(X) \to \bh$
...
\begin{lem} \label{lemlinm}
 ...
 \[
 \m{g, \Phi_f h} = f\m{g,h} \hspace{15pt}\text{ and }\hspace{15pt} \m{\Phi_f g, h} = \overline{f}\m{g,h}.
 \]
...
\end{gather*}
The other inequality is also true and will be proven in Lemma \ref{maintheorem5}.
\end{proof}
...
%    positive fucntion $f \colon X \to \R_+$, such that $f\neq 0$, and 
...
$\mc{A} \cap \setl f= \lambda \setr$ is non empty.
